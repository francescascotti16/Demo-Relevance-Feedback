...
from functions_similarity_metrics import shannon_entropy
...
def polyquery_sed_logscale(df, indexes_positive_initial_images, seed=0,  n_display=25, max_iter=20, alpha=1, beta=0.7, gamma=0.7, k_pos=-1, k_neg=-1,  initial_query=None, use_batch=False):
    '''
    Parameters
    ----------
    df : DataFrame
